...
class SimulationInstance:
    ...
    def __init__(self, algorithm, performance_metric, request_sequence, cost_func, init_state=None):
    ...
    def simualte(self):
        ...
        for file in request_sequence:
            # caching algorithm takes requested file??? and returns file to be replaced file
            replacement_address = cache.caching_algorithm(file, performace_metric)
